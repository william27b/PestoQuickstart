...
//
//                        slideSubsystem.setRunMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
//                        slideSubsystem.setManualPower(1.0);
...
//                        mecanumController.drive(0,0,0);
//
//                        slideSubsystem.setRunMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
//                        slideSubsystem.setFullPower(false);
//                        slideSubsystem.setState(CLIMB_UP);
//                        slideSubsystem.setRunMode(DcMotor.RunMode.RUN_TO_POSITION);
//
...
//            if (transferState == CLIMB_SLIDES_UP)
//                mecanumController.drive(-(-50 - slideSubsystem.getPosition()) / 800, 0, 0);
//
...
//                continue;
            ...
            if (gamepadInterface1.isKey(DPAD_DOWN)) {
                ...
                if (FrontalLobe.hasMacro("slides - reset")) {
                    FrontalLobe.removeMacros("slides - reset");
